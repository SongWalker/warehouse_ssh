		...
		<div id="rightSide">
			...
			<div class="wrapper">
				...
				<div class="widget">
					...
					<!--商品类别表属性列出-->
					<form method="post" action="<%=basePath%>goodsType/add.action">
						<table width="100%" >
								<tr>
									<td>
										商品种类
									...
									<td>
										<input type="text" name="tbgoodsType.gtName" />
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<input type="text" name="tbgoodsType.gtId" />
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<input type="text" name="tbgoodsType.gtDes" />
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<select name="tbgoodsType.gtState">
											<option value="1">
												可用
											</option>
											<option value="0">
						...
						<a href="<%=basePath%>goodsType/list.action">返回</a>
					</form>
					<!--onclick方法调用-->
				</div>
