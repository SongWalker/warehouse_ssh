...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 -->
    <div class="wrapper">
        ...
        <form method="post" action="<%=basePath%>goodsType/list.action">
             输入条件(商品种类/种类ID): <input type="text" name="zhonglei" size="18" />
        <input type="submit"  value="查询"/>
            <a href="<%=basePath%>inforManage/goodsType/addGoodsType.jsp">添加</a>
            <br />
       <!-- Dynamic table -->
        <div class="widget">
          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>商品类别信息</h6></div>
            ...
            <s:iterator value="#request.list" var="item">                                          <!--方法没写-->
                <tr>
                    ...
                    <th>${item.gtState}</th>
                    <th>
                       <a href="<%=basePath%>goodsType/tomodify.action?tbgoodsType.gtId=${item.gtId}">编辑</a>
                    </th>
                </tr>
            </s:iterator>
                </tbody>
