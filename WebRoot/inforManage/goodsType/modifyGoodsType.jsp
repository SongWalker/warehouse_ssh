...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 -->
    <div class="wrapper">
       ...
       <!-- Dynamic table -->
        <div class="widget">
          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>商品类别信息添加</h6></div>
                                                                <!--商品类别表属性列出--> 
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable" id="tb">          
				<tr>
					...
					<td>
						<input type="text" name="tbgoodsType.gtName" value="${tbgoodsType.gtName }" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="tbgoodsType.gtDes"  value="${tbgoodsType.gtDes }" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<select name="tbgoodsType.gtState" value="${tbgoodsType.gtState }">
							<option value="1">
								可用
							</option>
							<option value="0">
				...
				<td style="width: 30%; text-align: right">
						<input type="hidden" name="tbgoodsType.gtId" value="${tbgoodsType.gtId}"/>
					</td>
