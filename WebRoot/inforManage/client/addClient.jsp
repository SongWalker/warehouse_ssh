...
<!-- Left side content -->
    ...
    <div class="line"></div>
		...
		<form method="post" action="<%=basePath%>client/add.action">
			<table style="width: 100%">
				...
				<tr>
					...
					<td>
						<input type="text" name="tbc.CName" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="tbc.CSname" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="tbc.CAddress" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="tbc.CPostcode" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="tbc.CContacts" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="tbc.CCtel" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="tbc.CEmail" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="tbc.CBank" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="tbc.CBaccount" />
					</td>
				</tr>
