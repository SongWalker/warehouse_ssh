...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 html 在最后可分为多个html， 这个是进货退货销售单-->
     <div class="wrapper">
		...
		<form method="post" action="<%=basePath%>client/modify.action">
        

       <!-- Dynamic table -->
        <div class="widget">
          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>用户信息修改</h6></div>
            <table  width="100%" >
                <tr>
                	<td>客户姓名</td>
                	<td><input type="text" name="tbc.CName"   value="${tbc.CName}"  /></td>
                </tr>
                <tr>
                	<td>客户简称</td>
					<td><input type="text" name="tbc.CSname"   value="${tbc.CSname}"  /></td>
                </tr>
                <tr>
                	<td>地址</td>
                	<td><input type="text" name="tbc.CAddress"   value="${tbc.CAddress}"  /></td>
                </tr>
                <tr>
                	<td>邮编</td>
                	<td><input type="text" name="tbc.CPostcode"   value="${tbc.CPostcode}"  /></td>
                </tr>
                <tr>
                	<td>传真</td>
                	<td><input type="text" name="tbc.CFax"   value="${tbc.CFax}"  /></td>
                </tr>
                <tr>
                	<td>联系人</td>
                	<td><input type="text" name="tbc.CContacts"   value="${tbc.CContacts}"  /></td>
                </tr>
                <tr>
                	<td>联系人电话</td>
                	<td><input type="text" name="tbc.CCtel"   value="${tbc.CCtel}"  /></td>
                </tr>
                <tr>
                	<td>Email</td>
                	<td><input type="text" name="tbc.CEmail"   value="${tbc.CEmail}"  /></td>
                </tr>
                <tr>
                	<td>银行账号</td>
                	<td><input type="text" name="tbc.CBank"   value="${tbc.CBank}"  /></td> 
                </tr>
                <tr>
                	<td>银行账单</td>
					<td>
						<input type="text" name="tbc.CBaccount" value="${tbc.CBaccount}"/>
					</td>
                </tr>
                <tr>
                	<td>备注</td>
                	<td>						
                		<select name="tbc.CState" value="${tbc.CState}">
							<option value="1">
								可用
							</option>
							<option value="0">
						...
						<input type="hidden" name="tbc.CId" value="${tbc.CId}"/>
						<input type="submit" value="提交" />
						<a href="<%=basePath%>client/list.action">返回</a>
        </div>
