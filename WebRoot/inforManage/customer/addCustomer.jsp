...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 -->
    <div class="wrapper">
        ...
        <form method="post" action="<%=basePath%>customer/add.action">
       <!-- Dynamic table -->
        <div class="widget">
          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>客户信息增加</h6></div>
            <table width="100%" >
                <tr>
                    <td style="width: 30%; text-align: right">用户名</td>
                    <td><input type="text" name="user.UUid" /></td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">密码</td>
                    <td><input type="text" name="user.UPass"      /></td>
				</tr>
                <tr>
                ...
                <tr>
                	...
                	<td><input type="text" name="user.UTel"      /></td>
                </tr>
                <tr>
                	<td style="width: 30%; text-align: right">年龄</td>
                	<td><input type="text" name="user.UAge"      /></td>
                </tr>
                <tr>
                	<td style="width: 30%; text-align: right">性别</td>
                	<td>
                        <select name="user.USex">
                            <option value="1">
                                男
                            </option>
                            <option value="0">
                ...
                <tr>
                   ...
                   <button onclick="">增加</button>     <!--onclick方法调用-->
