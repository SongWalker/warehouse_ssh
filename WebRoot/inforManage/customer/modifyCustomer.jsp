...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 html 在最后可分为多个html， 这个是进货退货销售单-->
    <div class="wrapper">
        ...
        <form method="post" action="<%=basePath%>customer/modify.action">
       <!-- Dynamic table -->
        <div class="widget">
          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>客户信息修改</h6></div>
            <table  width="100%" >
                <tr>
                    <td style="width: 30%; text-align: right">用户名</td>
                    <td><input type="text" name="user.UUid" value="${user.UUid}" /></td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">密码</td>
                    <td><input type="text" name="user.UPass"   value="${user.UPass}"   /></td>
				</tr>
                <tr>
                ...
                <tr>
                	<td style="width: 30%; text-align: right">电话</td>
                	<td><input type="text" name="user.UTel"   value="${user.UTel}"   /></td>
                </tr>
                <tr>
                	<td style="width: 30%; text-align: right">年龄</td>
                	<td><input type="text" name="user.UAge"   value="${user.UAge}"   /></td>
                </tr>
                <tr>
                	<td style="width: 30%; text-align: right">性别</td>
                	<td>
                        <select name="user.USex" value="${user.USex}">
                            <option value="1">
                                男
                            </option>
                            <option value="0">
                ...
                <tr>
                	...
                	<td>
                        <select name="user.UState"  value="${user.UState}">
                            <option value="1">
                                可用
                            </option>
                            <option value="0">
            ...
            <input type="submit" value="提交" />
                        <a href="<%=basePath%>customer/list.action">返回</a>
        </div>
