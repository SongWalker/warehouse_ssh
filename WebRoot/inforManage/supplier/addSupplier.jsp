...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 -->
    <div class="wrapper">
       ...
       <!-- Dynamic table -->
    <form method="post" action="<%=basePath%>supplier/add.action">
        <div class="widget">
          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>供应商具体信息</h6></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable" id="tb">
				<tr>
					<td>供应商ID</td>
                    <td><input type="text" name="tbsup.SId"      /></td> 
				</tr>
				<tr>
					<td>供应商姓名</td>
                    <td><input type="text" name="tbsup.SName"      /></td>
				</tr>
				<tr>
					<td>供应商简称</td>
                    <td><input type="text" name="tbsup.SSname"      /></td>
				</tr>
				<tr>
					<td>地址</td>
                    <td><input type="text" name="tbsup.SAddress"      /></td>
				</tr>
				<tr>
					<td>邮编</td>
                    <td><input type="text" name="tbsup.SPostcode"      /></td>
				</tr>
				<tr>
					<td>电话</td>
                    <td><input type="text" name="tbsup.STel"      /></td>
				</tr>
				<tr>
					<td>传真</td>
                    <td><input type="text" name="tbsup.SFax"      /></td>
				</tr>
				<tr>
					<td>联系人</td>
                    <td><input type="text" name="tbsup.SContacts"      /></td>
				</tr>
				<tr>
					<td>联系人电话</td>
                    <td><input type="text" name="tbsup.SCtel"      /></td>
				</tr>
				<tr>
					<td>供应商银行账号</td>
                    <td><input type="text" name="tbsup.SBank"      /></td>
				</tr>
				<tr>
					<td>Email</td>
                    <td><input type="text" name="tbsup.SEmail"      /></td>
				</tr>
				<tr>
					<td>状态</td>
                    <td>                        
                        <select name="tbsup.SState">
                            <option value="1">
                                可用
                            </option>
                            <option value="0">
