...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 html 在最后可分为多个html， 这个是进货退货销售单-->
    <div class="wrapper">
       ...
       <!-- Dynamic table -->
            <form method="post" action="<%=basePath%>supplier/modify.action">
        <div class="widget">
          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>供应商信息修改</h6></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable" id="tb">
                
				<tr>
					<td>供应商姓名</td>
                    <td><input type="text" name="tbsup.SName"    value="${tbsup.SName}"    /></td>
				</tr>
				<tr>
					<td>供应商简称</td>
                    <td><input type="text" name="tbsup.SSname"     value="${tbsup.SSname}"   /></td>
				</tr>
				<tr>
					<td>地址</td>
                    <td><input type="text" name="tbsup.SAddress"    value="${tbsup.SAddress}"  /></td>
				</tr>
				<tr>
					<td>邮编</td>
                    <td><input type="text" name="tbsup.SPostcode"   value="${tbsup.SPostcode}"     /></td>
				</tr>
				<tr>
					<td>电话</td>
                    <td><input type="text" name="tbsup.STel"     value="${tbsup.STel}"   /></td>
				</tr>
				<tr>
					<td>传真</td>
                    <td><input type="text" name="tbsup.SFax"     value="${tbsup.SFax}"   /></td>
				</tr>
				<tr>
					<td>联系人</td>
                    <td><input type="text" name="tbsup.SContacts"     value="${tbsup.SContacts}"   /></td>
				</tr>
				<tr>
					<td>联系人电话</td>
                    <td><input type="text" name="tbsup.SCtel"        value="${tbsup.SCtel}"/></td>
				</tr>
				<tr>
					<td>供应商银行账号</td>
                    <td><input type="text" name="tbsup.SBank"      value="${tbsup.SBank}"/></td>
				</tr>
				<tr>
					<td>Email</td>
                    <td><input type="text" name="tbsup.SEmail"    value="${tbsup.SEmail}"    /></td>
				</tr>
				<tr>
					<td>状态</td>
                    <td>                        
                        <select name="tbsup.SState" value="${tbsup.SState}">
                            <option value="1">
                                可用
                            </option>
                            <option value="0">
                        ...
                        <input type="hidden" name="tbsup.SId" value="${tbsup.SId}"/>
                        <input type="submit" value="提交" />
                        <a href="<%=basePath%>supplier/list.action">返回</a>
     <!--onclick方法调用-->
        </div>
