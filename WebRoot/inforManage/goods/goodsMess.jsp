...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 html 在最后可分为多个html， 这个是进货退货销售单-->
    <div class="wrapper">
       ...
       <!-- Dynamic table -->
        <div class="widget">
          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>商品信息查询</h6></div>
            ...
            <s:iterator value="#request.list" var="item">                                          <!--方法没写-->
                <tr>
                    ...
                    <th>${item.GSname}</th>
                    <th>${item.GState}</th>
                    <th><a href="<%=basePath%>goods/tomodify.action?tbgoods.GId=${item.GId}">编辑</a></th>
                </tr>
            </s:iterator>
                </tbody>
            </table>   
