...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 html 在最后可分为多个html， 这个是进货退货销售单-->
    <div class="wrapper">
       ...
       <!-- Dynamic table -->
        <div class="widget">
          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>商品信息修改</h6></div>
          <form method="post" action="<%=basePath%>goods/modify.action">
            <table width="100%" >
								...
								<tr>
									...
									<td>
										<input type="text" name="tbgoods.GGtname"   value="${tbgoods.GGtname}" />
									</td>
								</tr>
								<tr>
									<td style="width: 30%; text-align: right">
									...
									<td>
										<input type="text" name="tbgoods.GName"  value="${tbgoods.GName}"  />
									</td>
								</tr>
								<tr>
									<td style="width: 30%; text-align: right">
								...
								<tr>
									...
									<td>
										<input type="text" name="tbgoods.GOrigin"   value="${tbgoods.GOrigin}" />
									</td>
								</tr>
								<tr>
									<td style="width: 30%; text-align: right">
									...
									<td>
										<input type="text" name="tbgoods.GUnit" value="${tbgoods.GUnit}" />
									</td>
								</tr>
								<tr>
									<td style="width: 30%; text-align: right">
									...
									<td>
										<input type="text" name="tbgoods.GStandard" value="${tbgoods.GStandard}"  />
									</td>
								</tr>
								<tr>
									<td style="width: 30%; text-align: right">
									...
									<td>
										<input type="text" name="tbgoods.GPack"  value="${tbgoods.GPack}"/>
									</td>
								</tr>
								<tr>
									<td style="width: 30%; text-align: right">
									...
									<td>
										<input type="text" name="tbgoods.GNo" value="${tbgoods.GNo}"/>
									</td>
								</tr>
								<tr>
									<td style="width: 30%; text-align: right">
									...
									<td>
										<input type="text" name="tbgoods.GNumber"  value="${tbgoods.GNumber}" />
									</td>
								</tr>
								<tr>
									<td style="width: 30%; text-align: right">
								...
								<tr>
									...
									<td>
										<select name="tbgoods.GState"  value="${tbgoods.GState }">
                                    		<option value="1">
                                        		可用
                                    		</option>
                                    		<option value="0">
                    ...
                    <input type="hidden" name="tbgoods.GId" value="${tbgoods.GId}"/>
