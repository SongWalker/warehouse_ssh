...
<form method="post" action="<%=basePath%>sell/add.action">
		<table style="width:100%">
			<tr>
				...
				<td>
					<input type="text" name="store.semNo" value="XS"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="store.semSum"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
			...
			<tr>	
				...
				<td>
					...
					<input id="endDate" name="store.semDate" readonly="readonly" onfocus="WdatePicker({isShowWeek:true})" />		
				</td>
			</tr>	
			<tr>	
				<td style="width: 30%; text-align: right">
			...
			<tr>	
				...
				<td>
					<select name="store.semCalculate">
