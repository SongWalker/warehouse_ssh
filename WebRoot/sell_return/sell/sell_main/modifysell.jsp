...
<form method="post" action="<%=basePath%>sell/modify.action">
		<table style="width:100%">
			<tr>
				...
				<td>
					<input type="text" name="store.semNo" value="${store.semNo}"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="store.semSum" value="${store.semSum}"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="store.semReceive" value="${store.semReceive}">
						<option <s:if test='store.semReceive=="合格"'>selected="selected"</s:if> value="合格">合格</option>
						<option <s:if test='store.semReceive=="不合格"'>selected="selected"</s:if> value="不合格">不合格</option>
						<option <s:if test='store.semReceive=="损坏"'>selected="selected"</s:if> value="损坏">损坏</option>
					</select>
				</td>
			</tr>
			<tr>	
				...
				<td>
					<select name="store.semSname" value="${store.semSname}">
						<s:iterator value="#request.slist" var="item">
							<option value="${item.CName}" <s:if test="store.semSname==#item.CName"> selected="selected"</s:if>>
								${item.CName}
							</option>
						</s:iterator>								
					</select>
			...
			<tr>	
				...
				<td>
					...
					<input id="endDate" name="store.semDate" value="${store.semDate}" readonly="readonly" onfocus="WdatePicker({isShowWeek:true})" />		
				</td>
			</tr>	
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="store.semUser" value="${store.semUser}">
						<s:iterator value="#request.ulist" var="item">
							<option value="${item.UName}" <s:if test="store.semUser==#item.UName"> selected="selected"</s:if>>
								${item.UName}						 
							</option>
						</s:iterator>
					</select>
			...
			<tr>	
				...
				<td>
					<select name="store.semCalculate" value="${store.semCalculate}">
						<option <s:if test='store.semCalculate=="现金"'>selected="selected"</s:if> value="现金">现金</option>
						<option <s:if test='store.semCalculate=="支票"'>selected="selected"</s:if> value="支票">支票</option>
						<option <s:if test='store.semCalculate=="信用卡"'>selected="selected"</s:if> value="信用卡">信用卡</option>						
						<option <s:if test='store.semCalculate=="银行转账"'>selected="selected"</s:if> value="银行转账">银行转账</option>
						<option <s:if test='store.semCalculate=="微信转账"'>selected="selected"</s:if> value="微信转账">微信转账</option>
						<option <s:if test='store.semCalculate=="支付宝转账"'>selected="selected"</s:if> value="支付宝转账">支付宝转账</option>
					</select>
				</td>
			</tr>	
			<tr>	
				...
				<td>
					<select name="store.semState" value="${store.semState}">
						<option value="1">
								正常
						</option>
						<option value="0">
			...
			<tr>
				<td style="width: 30%; text-align: right">
					<input type="hidden" name="store.semId" value="${store.semId}"/>
				</td>
