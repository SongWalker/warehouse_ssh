...
<form method="post" action="<%=basePath%>sell/listd.action">
      销售单号:<input type=“text” name="sd.sedNo" value="${sd.sedNo}"/>
      ...
      <table style="width:100%">
        ...
        <s:iterator value="#request.listd" var="item">
          <tr>
            <td>${item.sedNo}</td>
            <td>${item.sedGid}</td>
            <td>${item.sedUprice}</td>
            <td>${item.sedNumber}</td>
            <td>${item.sedState}</td>
            <td>
              <a href="<%=basePath%>sell/dtomodify.action?sd.sedId=${item.sedId}">修改</a>
            </td>
          </tr>
        </s:iterator>
      </table>
      ...
      <td style="width:30%; text-align: left"><br><br></td>
        <td>
          <a href="<%=basePath%>sell/list.action">返回销售单页</a>
        </td>
      </tr>
    </form>
