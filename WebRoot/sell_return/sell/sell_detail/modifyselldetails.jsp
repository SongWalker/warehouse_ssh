...
<form method="post" action="<%=basePath%>sell/dmodify.action">
		<table style="width:100%">
			...
			<tr>
				...
				<td>
					<select name="sd.sedGid" value="${sd.sedGid}">
						<s:iterator value="#request.alistd" var="item">
							<option value="${item.GNo}"  <s:if test="sd.sedGid==#item.GNo"> selected="selected"</s:if>>
			...
			<tr>
				...
				<td>
					<input type="text" name="sd.sedUprice" value="${sd.sedUprice}"/>
				</td>
			</tr>
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="sd.sedNumber" value="${sd.sedNumber}"/>
				</td>
			</tr>		
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="sd.sedState" value="${sd.sedState}">
						<option value="1">
								正常
						</option>
						<option value="0">
			...
			<tr>
				<td style="width: 30%; text-align: right">
					<input type="hidden" name="sd.sedId" value="${sd.sedId}"/>
				</td>
				<td style="width: 30%; text-align: right"><br><br></td>
				<td>
					<input type="submit" value="提交" />
					<a href="<%=basePath%>sell/listd.action">返回</a>
				</td>
			</tr>	
    	</table>
    	</form>
