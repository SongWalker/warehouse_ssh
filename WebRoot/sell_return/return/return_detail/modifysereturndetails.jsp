...
<form method="post" action="<%=basePath%>sell/dmodifyr.action">
		<table style="width:100%">
			<tr>
				...
				<td>
					<input readonly type="text" name="rtnd.srdNo" value="${rtnd.srdNo}"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="rtnd.srdGid" value="${rtnd.srdGid}">
						<s:iterator value="#request.alistd" var="item">
							<option value="${item.GNo}"  <s:if test="rtnd.srdGid==#item.GNo"> selected="selected"</s:if>>
							${item.GNo} 商品名称：${item.GName}
							</option>
						</s:iterator>								
					</select>
				</td>
			...
			<tr>
				...
				<td>
					<input type="text" name="rtnd.srdUprice" value="${rtnd.srdUprice}"/>
				</td>
			</tr>
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="rtnd.srdNumber" value="${rtnd.srdNumber}"/>
				</td>
			</tr>		
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="rtnd.srdState" value="${rtnd.srdState}">
						<option value="1">
								正常
						</option>
						<option value="0">
			...
			<tr>
				<td style="width: 30%; text-align: right">
					<input type="hidden" name="rtnd.srdId" value="${rtnd.srdId}"/>
				</td>
				<td style="width: 30%; text-align: right"><br><br></td>
				<td>
					<input type="submit" value="提交" />
					<a href="<%=basePath%>sell/listrd.action">返回</a>
				</td>
			</tr>	
    	</table>
    	</form>
