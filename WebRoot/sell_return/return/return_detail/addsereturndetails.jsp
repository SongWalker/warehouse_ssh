...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 -->
    <div class="wrapper">
        		...
        		<form method="post" action="<%=basePath%>sell/addrdetail.action">
		<table style="width:100%">
			...
			<tr>
				...
				<td>
					<input type="text" name="rtnd.srdUprice"/>
				</td>
			</tr>
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="rtnd.srdNumber"/>
				</td>
			</tr>	
				<td style="width: 30%; text-align: right">
					是否有效：
			...
			<tr>
				<td style="width: 30%; text-align: right">
					<input type="hidden" name="rtnd.srmId" value="${rtnd.srmId}"/>
				</td>
				<td>
