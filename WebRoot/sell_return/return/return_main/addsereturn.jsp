...
<form method="post" action="<%=basePath%>sell/addr.action">
		<table style="width:100%">
			<tr>
				...
				<td>
					<input type="text" name="rtn.srmNo" value="TH"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="rtn.srmSum"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
			...
			<tr>	
				...
				<td>
					...
					<input id="endDate" name="rtn.srmDate" readonly="readonly" onfocus="WdatePicker({isShowWeek:true})" />		
				</td>
			</tr>	
			<tr>	
				<td style="width: 30%; text-align: right">
