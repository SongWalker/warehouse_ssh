...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 -->
    <div class="wrapper">
		...
		<form method="post" action="<%=basePath%>record/add.action">
			<table style="width: 100%">
				<tr>
					...
					<td>
						<input type="text" name="record.idNo" />
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
					...
					<td>
						<input type="text" name="record.idGname" />
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
					...
					<td>
						<input type="text" name="record.idUnit" />
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
					...
					<td>
						<input type="text" name="record.idNum" />
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
					...
					<td>
                        ...
                        <input id="endDate" name="record.idDate" readonly="readonly" onfocus="WdatePicker({isShowWeek:true})" />
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
					...
					<td>
						<input type="text" name="record.idDes" />
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
