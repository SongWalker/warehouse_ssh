...
<form method="post" action="<%=basePath%>record/modify.action">
			<table style="width: 100%">
				...
				<tr>
					...
					<td>
						<input type="text" name="record.idGname" value="${record.idGname}" />
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
					...
					<td>
						<input type="text" name="record.idUnit" value="${record.idUnit}"/>
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
					...
					<td>
						<input type="text" name="record.idNum" value="${record.idNum}"/>
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
					...
					<td>
                        ...
                        <input id="endDate" name="record.idDate" value="${record.idDate}" readonly="readonly" onfocus="WdatePicker({isShowWeek:true})" />
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
					...
					<td>
						<input type="text" name="record.idDes" value="${record.idDes}"/>
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right">
					...
					<td>
						<select name="record.idState" value="${record.idState}">
							<option value="1">
								可用
							</option>
							<option value="0">
				...
				<tr>
					<td style="width: 30%; text-align: right">
						<input type="hidden" name="record.idId" value="${record.idId}"/>
					</td>
					<td>
						<input type="submit" value="提交" />
						<a href="<%=basePath%>record/list.action">返回</a>
					</td>
				</tr>
