...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="js/plugins/forms/jquery.cleditor.js"></script>
		<script type="text/javascript"
		...
		<script type="text/javascript"
			src="js/plugins/wizard/jquery.validate.min.js"></script>
		<script type="text/javascript"
			src="js/plugins/wizard/jquery.form.wizard.js"></script>
		...
		<script type="text/javascript"
			src="js/plugins/tables/tablesort.min.js"></script>
		<script type="text/javascript"
			src="js/plugins/tables/resizable.min.js"></script>

		<script type="text/javascript" src="js/plugins/ui/jquery.tipsy.js"></script>
		<script type="text/javascript"
			src="js/plugins/ui/jquery.collapsible.min.js"></script>
		<script type="text/javascript"
			src="js/plugins/ui/jquery.prettyPhoto.js"></script>
		<script type="text/javascript" src="js/plugins/ui/jquery.progress.js"></script>
		<script type="text/javascript"
			src="js/plugins/ui/jquery.timeentry.min.js"></script>
		<script type="text/javascript"
			src="js/plugins/ui/jquery.colorpicker.js"></script>
		<script type="text/javascript" src="js/plugins/ui/jquery.jgrowl.js"></script>
		<script type="text/javascript"
			src="js/plugins/ui/jquery.breadcrumbs.js"></script>
	...
	<body>
		...
		<div id="rightSide">
			...
			<div class="wrapper">
				...
				<form method="post" action="<%=basePath%>record/list.action">
					编号:
					<input type="text" name="record.idNo" value="${record.idNo}" />
					<input type="date" name="record.idDate" value="${record.idDate}" />
					<input type="submit" value="查询" />
					<a href="<%=basePath%>inventory/record/addRecord.jsp">添加</a>
					<br />
					<table style="width: 100%">
						...
						<s:iterator value="#request.list" var="item">
							<tr>
								...
								<td>
									<a
										href="<%=basePath%>record/tomodify.action?record.idId=${item.idId}">编辑</a>
								</td>
							</tr>
						</s:iterator>
					</table>
			...
			<div id="footer">
				<div class="wrapper">
					As usually all rights reserved.More Templates
					<a href="#/" target="_blank" title="进销存管理系统">进销存管理系统</a> - Collect
					from
					<a href="#" title="进销存管理系统" target="_blank">进销存管理系统</a>
				</div>
			</div>
