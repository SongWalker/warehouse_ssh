...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 html 在最后可分为多个html， 这个是进货退货销售单-->
    <div class="wrapper">
            <form method="post" action="<%=basePath%>inventory/modify.action">

       <!-- Dynamic table -->
        <div class="widget">
          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>库存信息修改</h6></div>
            <table width="100%" >
                <tr>
                    ...
                    <td>
                        <input type="text" name="inventory.INo" value="${inventory.INo}"/>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: right">
                    ...
                    <td>
                        <input type="text" name="inventory.IGname"  value="${inventory.IGname}" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: right">
                    ...
                    <td>
                        <input type="text" name="inventory.ISname" value="${inventory.ISname}" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: right">
                    ...
                    <td>
                        <input type="text" name="inventory.IOrigin"  value="${inventory.IOrigin}" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: right">
                    ...
                    <td>
                        <input type="text" name="inventory.IStandard" value="${inventory.IStandard}"/>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: right">
                    ...
                    <td>
                        <input type="text" name="inventory.INumber" value="${inventory.INumber}" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: right">
                    ...
                    <td>
                        <input type="text" name="inventory.IPack" value="${inventory.IPack}"  />
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: right">
                    ...
                    <td>
                        <input type="text" name="inventory.IUnit" value="${inventory.IUnit}" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: right">
                    ...
                    <td>
                        <input type="text" name="inventory.IUprice" value="${inventory.IUprice}" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; text-align: right">
                    ...
                    <td>
                        <select name="inventory.IState" value="${inventory.IState}" >
                            <option value="1">
                                可用
                            </option>
                            <option value="0">
                        ...
                        <input type="hidden" name="inventory.IId" value="${inventory.IId}"/>
