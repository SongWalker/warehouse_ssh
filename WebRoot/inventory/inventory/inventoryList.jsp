...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 -->
    <div class="wrapper">
       ...
       <!-- Dynamic table -->
        <div class="widget">
                    <form method="post" action="<%=basePath%>inventory/list.action">
                    名称:
            <input type="text" name="inventory.IGname" value="${inventory.IGname}" />
            <input type="submit" value="查询" />
            <a href="<%=basePath%>inventory/inventory/addInventory.jsp">添加</a>   
            <br />

          <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>库存查询</h6></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable" id="tb">
                ...
                <tr>
                    ...
                    <th>${item.IOrigin}</th>
                    <th>${item.IPack}</th>
                    <th>${item.IStandard}</th>
                    <th>${item.IUnit}</th>
                    <th>${item.IUprice}</th>
                    <th>${item.IState}</th>
                    <th><a href="<%=basePath%>inventory/tomodify.action?inventory.IId=${item.IId}">编辑</a></th>
                </tr>
                </s:iterator>
                </tbody>
            </table>     <!--onclick方法调用-->
