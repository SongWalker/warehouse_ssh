...
<div class="topNav">
    <div class="wrapper">
        <div class="userNav">
            <ul>
                <li><a href="#" title=""  style="align:right float:right"><img src="images/icons/topnav/messages.png" alt="" /><span>Contact us</span></a></li>
            </ul>
        </div>
        <div class="clear"></div>
    </div>
...
<div class="loginWrapper">
    ...
    <div class="widget">
        ...
        <form  method="post" action="<%=basePath%>login/login.action" id="validate" class="form">
            <fieldset>
                <div class="formRow">
                    <label for="login">UserID:</label>
                    <div class="loginInput"><input type="text" name="user.UUid" class="validate[required]" id="login" /></div>
                    <div class="clear"></div>
                </div>
                
                <div class="formRow">
                    <label for="pass">Password:</label>
                    <div class="loginInput"><input type="password"  name="user.UPass" class="validate[required]" id="pass" /></div>
                    <div class="clear"></div>
                </div>
