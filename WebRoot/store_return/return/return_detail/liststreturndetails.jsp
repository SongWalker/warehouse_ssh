...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 -->
    ...
    <form method="post" action="<%=basePath%>store/listrd.action">
      退货单号:<input type=“text” name="rtnd.rdNo" value="${rtnd.rdNo}"/>
      ...
      <table style="width:100%">
        ...
        <s:iterator value="#request.listrd" var="item">
          <tr>
            ...
            <td>${item.rdState}</td>
            <td>
              <a href="<%=basePath%>store/dtomodifyr.action?rtnd.rdId=${item.rdId}">修改</a>
            </td>
          </tr>
        </s:iterator>
      </table>
      ...
      <td style="width:30%; text-align: left"><br><br></td>
        <td>
          <a href="<%=basePath%>store/listr.action">返回退货单页</a>
        </td>
      </tr>
    </form>
