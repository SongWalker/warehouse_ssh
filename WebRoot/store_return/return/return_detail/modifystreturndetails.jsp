...
<form method="post" action="<%=basePath%>store/dmodifyr.action">
		<table style="width:100%">
			<tr>
				...
				<td>
					<input readonly type="text" name="rtnd.rdNo" value="${rtnd.rdNo}"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="rtnd.rdGid" value="${rtnd.rdGid}">
						<s:iterator value="#request.alistd" var="item">
							<option value="${item.GNo}"  <s:if test="rtnd.rdGid==#item.GNo"> selected="selected"</s:if>>
			...
			<tr>
				...
				<td>
					<input type="text" name="rtnd.rdUprice" value="${rtnd.rdUprice}"/>
				</td>
			</tr>
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="rtnd.rdNumber" value="${rtnd.rdNumber}"/>
				</td>
			</tr>		
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="rtnd.rdState" value="${rtnd.rdState}">
						<option value="1">
								正常
						</option>
						<option value="0">
			...
			<tr>
				<td style="width: 30%; text-align: right">
					<input type="hidden" name="rtnd.rdId" value="${rtnd.rdId}"/>
				</td>
				<td style="width: 30%; text-align: right"><br><br></td>
				<td>
					<input type="submit" value="提交" />
					<a href="<%=basePath%>store/listrd.action">返回</a>
				</td>
			</tr>	
    	</table>
    	</form>
