...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 -->
    <div class="wrapper">
		...
		<form method="post" action="<%=basePath%>store/modifyr.action">
		<table style="width:100%">
			<tr>
				...
				<td>
					<input type="text" name="rtn.rmNo" value="${rtn.rmNo}"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="rtn.rmSum" value="${rtn.rmSum}"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="rtn.rmReceive" value="${rtn.rmReceive}">
						<option <s:if test='rtn.rmReceive=="合格"'>selected="selected"</s:if> value="合格">合格</option>
						<option <s:if test='rtn.rmReceive=="不合格"'>selected="selected"</s:if> value="不合格">不合格</option>
						<option <s:if test='rtn.rmReceive=="损坏"'>selected="selected"</s:if> value="损坏">损坏</option>
					</select>
				</td>
			</tr>
			<tr>	
				...
				<td>
					<select name="rtn.rmSname" value="${rtn.rmSname}">
						<s:iterator value="#request.slist" var="item">
							<option value="${item.SName}" <s:if test="rtn.rmSname==#item.SName"> selected="selected"</s:if>>
								${item.SName}
							</option>
						</s:iterator>								
					</select>
			...
			<tr>	
				...
				<td>
					...
					<input id="endDate" name="rtn.rmRedate" value="${rtn.rmRedate}" readonly="readonly" onfocus="WdatePicker({isShowWeek:true})" />		
				</td>
			</tr>	
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="rtn.rmUser" value="${rtn.rmUser}">
			...
			<tr>	
				...
				<td>
					<select name="rtn.rmCalculate" value="${rtn.rmCalculate}">
						<option <s:if test='rtn.rmCalculate=="现金"'>selected="selected"</s:if> value="现金">现金</option>
						<option <s:if test='rtn.rmCalculate=="支票"'>selected="selected"</s:if> value="支票">支票</option>
						<option <s:if test='rtn.rmCalculate=="信用卡"'>selected="selected"</s:if> value="信用卡">信用卡</option>						
						<option <s:if test='rtn.rmCalculate=="银行转账"'>selected="selected"</s:if> value="银行转账">银行转账</option>
						<option <s:if test='rtn.rmCalculate=="微信转账"'>selected="selected"</s:if> value="微信转账">微信转账</option>
						<option <s:if test='rtn.rmCalculate=="支付宝转账"'>selected="selected"</s:if> value="支付宝转账">支付宝转账</option>
					</select>
				</td>
			</tr>	
			<tr>	
				...
				<td>
					<select name="rtn.rmState" value="${rtn.rmState}">
						<option value="1">
								正常
						</option>
						<option value="0">
			...
			<tr>
				<td style="width: 30%; text-align: right">
					<input type="hidden" name="rtn.rmId" value="${rtn.rmId}"/>
				</td>
				<td style="width: 30%; text-align: right"><br><br></td>
				<td>
					<input type="submit" value="提交" />
					<a href="<%=basePath%>store/listr.action">返回</a>
				</td>
			</tr>	
    	</table>
    	</form>
