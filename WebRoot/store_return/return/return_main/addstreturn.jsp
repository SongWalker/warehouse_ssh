...
<form method="post" action="<%=basePath%>store/addr.action">
		<table style="width:100%">
			<tr>
				...
				<td>
					<input type="text" name="rtn.rmNo" value="CK"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="rtn.rmSum"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
			...
			<tr>	
				...
				<td>
					...
					<input id="endDate" name="rtn.rmRedate" readonly="readonly" onfocus="WdatePicker({isShowWeek:true})" />		
				</td>
			</tr>	
			<tr>	
				<td style="width: 30%; text-align: right">
