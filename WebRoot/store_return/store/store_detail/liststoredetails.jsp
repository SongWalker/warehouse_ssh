...
<!-- Left side content -->
  ...
  <!-- Main content wrapper                 -->
    ...
    <form method="post" action="<%=basePath%>store/listd.action">
      入库单号:<input type=“text” name="sd.sdNo" value="${sd.sdNo}"/>
      ...
      <table style="width:100%">
        ...
        <s:iterator value="#request.listd" var="item">
          <tr>
            ...
            <td>${item.sdState}</td>
            <td>
              <a href="<%=basePath%>store/dtomodify.action?sd.sdId=${item.sdId}">修改</a>
            </td>
          </tr>
        </s:iterator>
      </table>
      ...
      <td style="width:30%; text-align: left"><br><br></td>
        <td>
          <a href="<%=basePath%>store/list.action">返回进货单页</a>
        </td>
      </tr>
    </form>
