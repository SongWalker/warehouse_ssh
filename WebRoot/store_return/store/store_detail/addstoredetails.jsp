...
<form method="post" action="<%=basePath%>store/adddetail.action">
		<table style="width:100%">
			...
			<tr>
				...
				<td>
					<input type="text" name="sd.sdUprice"/>
				</td>
			</tr>
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="sd.sdNumber"/>
				</td>
			</tr>	
				<td style="width: 30%; text-align: right">
					是否有效：
