...
<form method="post" action="<%=basePath%>store/dmodify.action">
		<table style="width:100%">
			<tr>
				...
				<td>
					<input readonly type="text" name="sd.sdNo" value="${sd.sdNo}"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="sd.sdGid" value="${sd.sdGid}">
						<s:iterator value="#request.alistd" var="item">
							<option value="${item.GNo}"  <s:if test="sd.sdGid==#item.GNo"> selected="selected"</s:if>>
			...
			<tr>
				...
				<td>
					<input type="text" name="sd.sdUprice" value="${sd.sdUprice}"/>
				</td>
			</tr>
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="sd.sdNumber" value="${sd.sdNumber}"/>
				</td>
			</tr>		
			<tr>	
				<td style="width: 30%; text-align: right">
				...
				<td>
					<select name="sd.sdState" value="${sd.sdState}">
						<option value="1">
								正常
						</option>
						<option value="0">
			...
			<tr>
				<td style="width: 30%; text-align: right">
					<input type="hidden" name="sd.sdId" value="${sd.sdId}"/>
				</td>
				<td style="width: 30%; text-align: right"><br><br></td>
				<td>
					<input type="submit" value="提交" />
					<a href="<%=basePath%>store/listd.action">返回</a>
				</td>
			</tr>	
    	</table>
    	</form>
