...
<form method="post" action="<%=basePath%>store/add.action">
		<table style="width:100%">
			<tr>
				...
				<td>
					<input type="text" name="store.smNo" value="RK"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
				...
				<td>
					<input type="text" name="store.smSum"/>
				</td>
			</tr>	
			<tr>
				<td style="width: 30%; text-align: right">
			...
			<tr>	
				...
				<td>
					...
					<input id="endDate" name="store.smStdate" readonly="readonly" onfocus="WdatePicker({isShowWeek:true})" />		
				</td>
			</tr>	
			<tr>	
				<td style="width: 30%; text-align: right">
